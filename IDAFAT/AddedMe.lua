...
if not DevAek:get(AEK..'Aek:Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
Dev_Aek(msg.chat_id_, msg.id_, 1, '♕︙انت منشئ المجموعه', 1, 'md') 
return false
end
...
DevAek:del(AEK..'Aek:Added:Me'..msg.chat_id_) 
Dev_Aek(msg.chat_id_, msg.id_, 1, '♕︙تم تفعيل امر منو ضافني', 1, 'md') 
end
if text == 'تعطيل ضافني' and Manager(msg) then 
DevAek:set(AEK..'Aek:Added:Me'..msg.chat_id_,true) 
Dev_Aek(msg.chat_id_, msg.id_, 1, '♕︙تم تعطيل امر منو ضافني', 1, 'md') 
end
end
