...
if DevAek:get(AEK.."Aek:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
if not Manager(msg) and DevAek:get(AEK.."Aek:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DevAekName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DevAekName then 
DevAekNames = DevAek:smembers(AEK.."Aek:Mute:Names"..msg.chat_id_) or ""
if DevAekNames and DevAekNames[1] then 
for i=1,#DevAekNames do 
if DevAekName:match("(.*)("..DevAekNames[i]..")(.*)") then 
