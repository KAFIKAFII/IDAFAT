...
if DevAek:get(AEK.."Aek:Lock:ProNames"..msg.chat_id_) and DevAek:get(AEK.."Aek:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAek:get(AEK.."Aek:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAek:srem(AEK..'Aek:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAek:get(AEK.."Aek:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAek:get(AEK.."Aek:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
